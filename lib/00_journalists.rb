...
#1 Count number of journalists
puts journalists.size

#2 Count number of email adresses containing a number
...
puts journalists.count { |journalist| journalist.match(/^.{1}[A-Z]/) }
puts journalists.count { |journalist| journalist.match(/^@[A-Z]/) }

#5 Count emails that have only one capital letter
puts journalists.count { |journalist| journalist.match(/\p{Lu}/) }
